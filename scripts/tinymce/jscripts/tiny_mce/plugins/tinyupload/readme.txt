...
1. After a file upload in msie the textboxes lockup.

------Change Log------

***26-08-2008***

1. An atempt to impliment the technique discused here http://www.quirksmode.org/dom/inputfile.html to 
style the file input.

2. Problem with the whole file path being attached to the url instead of just the file name should now 
be resolved.