function tinyupload(field_name, url, type, win){
	...
	*/
	...
	CONFIG
	*/
	var pathToPhp = '/scripts/tinymce/jscripts/tiny_mce/plugins/tinyupload/tinyupload.php';
	/*
	Nothing to edit past this point unless you know what your doing.
	*/
	win.tuSeclectedUrl = '';
	win.tuIframeLoaded = function(path){}
	...
	*/
	...
	el2.style.cssText = 'height:40px;width:290px;background:#ffffff;border-width:0px;';
	...
	*/
	...
	win.tuFileUploadStarted = function(){
            win.tuIframeLoaded = rntUrl;
            return true;
	}
