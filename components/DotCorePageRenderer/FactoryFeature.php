...
class FactoryFeature extends FactoryBase
{
	...
	public function Create()
	{
		...
		$feature_record = (isset(self::$features_commands_classes_dictionary[$feature_command])) ? self::$features_commands_classes_dictionary[$feature_command] : NULL;

		if(!is_object($feature_record) && $feature_record == -1)
		{
